...
*
*
* Adaptations for the Liftweb framework made by
* Timothy Perrett. Removed several header calls
* and standardised the json feedback.
*
*/
(function($) {
...
jQuery.uploadProgress = function(e, options) {
  //alert("Starting remote call. OPtions: " + options);
  jQuery.ajax({
    type: "GET",
    url: options.progressUrl + "?" + new Date().getTime(),
